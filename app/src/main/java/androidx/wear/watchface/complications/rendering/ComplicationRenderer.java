...
class ComplicationRenderer {
    ...
    public void draw(
        ...
        if ( !drawRangedValue(canvas, currentPaintSet, mIsPlaceholderRangedValue)) {
    ...
    private boolean drawRangedValue(Canvas canvas, PaintSet paintSet, Boolean isPlaceholder) {
